...
export const localWeapons = [
	{
		id: 'ObeDragon',
		title: 'Дракон',
		category: 'Нейтральный персонаж ОБЕ',
	...
	},
	{
		...
		title: 'Хиш-Ку-Тен',
		category: 'Нейтральный персонаж ОБЕ',
		image: require('../images/TehList/ObeHish-Ku-Ten.jpg'),
		price: 140,
		inBasket: true,
		button: '',
	...
	{
		id: 'ObeKern_Krovavoe_Kopito',
		title: 'Кэрн Кровавое Копыто',
		category: 'Нейтральный персонаж ОБЕ',
		image: require('../images/TehList/ObeKern_Krovavoe_Kopito.jpg'),
		price: 130,
		inBasket: true,
		button: '',
		marker: require('../images/marker_new.png'),
